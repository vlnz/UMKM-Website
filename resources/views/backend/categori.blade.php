                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('categories/' . $item->id . '/edit') }}"
                                            class="btn btn-success btn-block mb-2" style="padding: 7px 25px;">Edit</a>

                                        <a href="{{ url('categories/' . $item->id . '/delete') }}"
                                            class="btn btn-danger btn-block" style="padding: 7px 16px;" onclick="return confirm('Yakin Deleted ?')">
                                            Delete
                                        </a>
                                    </td>
                                </tr>
